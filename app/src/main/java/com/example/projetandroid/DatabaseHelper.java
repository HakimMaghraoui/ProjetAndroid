...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void initData(){
        createArtist("Miles", "Devis", "artist_miles_devis", "Miles Dewey Davis III, né le 26 mai 1926 à Alton (Illinois) et mort le 28 septembre 1991 à Santa Monica (Californie), est un compositeur et trompettiste de jazz américain.","USA", "Jazz", "");
