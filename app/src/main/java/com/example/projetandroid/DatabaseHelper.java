...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void initData(){
        ...
        createArtist("Skrillex", "", "artist_skrillex", "Skrillex, de son vrai nom Sonny John Moore, né le 15 janvier 1988 à Los Angeles, est un DJ et compositeur américain de musique électronique. Après avoir grandi au nord de la Californie, Sonny Moore rejoint le groupe de post-hardcore From First to Last en tant que chanteur en 2004 et y enregistre deux albums studio (Dear Diary, My Teen Angst Has a Body Count en 2004, et Heroine en 2006) avant de se lancer dans une carrière musicale en solo. Il lance sa première tournée en solo la même année. Aux côtés d'une nouvelle formation de groupe, Sonny Moore joue à l'Alternative Press Tour en soutien à des groupes comme All Time Low et The Rocket Summer et apparaît sur la couverture des « 100 groupes à connaître » du magazine Alternative Press.", "USA", "Electronic");
